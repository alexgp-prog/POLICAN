...
plt.imshow(im1, origin = 'lower', cmap = 'gray', vmax = 6*im1.flatten().std(), vmin = -im1.flatten().std())
plt.grid(False)
cb = plt.colorbar()
...
im = ax0.imshow(im1,vmax = im1.flatten().std(), vmin = -im1.flatten().std(), cmap='Greys_r'
